...
- **2bitent-site** (`9803a8a5-536f-44ab-aef6-21651ed48de9`) — 2bitENT agency site; use `Dockerfile.ent` + `DEPLOY-ENT.md`
- **2bitent-site (legacy)** (`8334c011-9071-46ca-bb97-7929d618d176`) — deprecated; do not deploy
