  ...
  return (
    <Paper compact elevated className="w-full">
      <div className="flex flex-col gap-2.5">
        ...
        <StudioAppLink className="rounded-full border border-ink/20 px-4 py-2 text-center text-[11px] font-semibold uppercase tracking-wider text-ink transition hover:bg-ink hover:text-paper-cream">
          Open studio apps ↓
        </StudioAppLink>
      </div>
    </Paper>
