...
export const careerGraphEdges: CareerGraphEdge[] = [
  ...
  { id: "cg-2bit-founder-hatalom", source: "exp-node-2bit-founder", target: "exp-node-hatalom", type: "employment_sequence", connectionNote: "simulation contract" },
  ...
  { id: "cg-hatalom-pause", source: "exp-node-hatalom", target: "exp-node-2bit-pause", type: "employment_sequence", connectionNote: "break from software" },
