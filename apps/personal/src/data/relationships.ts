...
export const graphEdges: GraphEdge[] = [
  ...
  { id: "e-2bit-google", source: "exp-node-2bit", target: "client-google", relationship: "built-with", connectionNote: "via Uncorked" },
  { id: "e-2bit-dell", source: "exp-node-2bit", target: "client-dell", relationship: "built-with", connectionNote: "via Nice Touch" },
  { id: "e-2bit-washu", source: "exp-node-2bit", target: "client-wash-u", relationship: "built-with", connectionNote: "via Nice Touch" },
