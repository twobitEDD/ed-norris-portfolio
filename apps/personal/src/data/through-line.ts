...
export const storyStops: StoryStop[] = [
  ...
  },
  {
    ...
    copy:
      "ERGO.games brings the arc full circle: local/online multiplayer, a game marketplace with a private ownership model — the same commitment to making complex things feel worth people's time.",
  },
  {
    nodeId: "person-ed",
