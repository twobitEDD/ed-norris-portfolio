...
export const timelineEras: TimelineEra[] = [
  ...
  },
  {
    ...
    summary:
      "Operational indie studio 2012–2014 developing Planet's Core (did not ship), plus military simulation software at Hatalom Systems (2014), then later catalog releases — Fish Fight, ERGnomes, and PokePocket — alongside agency contracts after re-establishing in 2018. Studio on hold 2014–2018 during teaching jobs and public-service work. Re-established in 2018 as a software production business — contracting through Nice Touch, Uncorked, and other agencies for Google, Dell, Washington University, and additional clients.",
    disciplines: ["games", "marketing", "operations"],
    caption: "2bit studio",
    polaroidGradient: "linear-gradient(160deg, #6b5a8a, #2a2038)",
    detailBody: [
      "Founded 2bit Entertainment in 2012 after Rocket Gaming and developed Planet's Core as the studio's founder-era indie title (2012–2014; did not ship) — technical design, art integration, team leadership, and business strategy on a founder's timeline.",
      "A six-month engineering engagement at Hatalom Systems (2014) applied the same game-industry craft to proprietary military simulation and game-based training software — part of 2bit's software production work after Planet's Core development ended and before the studio pause.",
      "The studio catalog grew across both phases: Planet's Core as the founder-era title in development (did not ship); Fish Fight (fishFight.app) for ocean-conservation web play; ERGnomes.io for NFT ecosystem technical design on the Ergo Platform; and PokePocket as accessible pocket-format game experiments — shipped alongside agency-backed client work, not instead of it.",
    ...
    highlights: [
      "Planet's Core — founder-era indie title in development at 2bit Entertainment (2012–2014; did not ship)",
